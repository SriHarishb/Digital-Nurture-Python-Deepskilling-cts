...
# API Gateway: single public entry point (port 5000) that transparently
# forwards each request to the correct backend microservice (course/student
# services) so clients never need to know the internal service topology.
app = Flask(__name__)
