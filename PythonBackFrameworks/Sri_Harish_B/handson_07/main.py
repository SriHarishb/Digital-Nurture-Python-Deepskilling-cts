...
def send_confirmation_email(student_email: str):
    # Simulates a slow side-effect (e.g. sending an email). Running this via
    # BackgroundTasks means the enrollment request returns to the client
    # immediately, without waiting on this "email send".
